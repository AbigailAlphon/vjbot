...
API_ID = int(environ.get('API_ID', '29740905'))
API_HASH = environ.get('API_HASH', 'd2d1f98ac264f17c6c0262661951f2a7')
BOT_TOKEN = environ.get('BOT_TOKEN', "6594623430:AAFTl5OkdMFAHpTMgErxAimqntHbfgiOHjc")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/0kY.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5108672938').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002110842395'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002021915284').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002259471693') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://markelisa25:oBS3Jl7MOcIggyNc@cluster0.fgfmoz6.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+ZB_krsECIE8yYzFk')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/the_moviebufffs')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/notmoviebuff')
